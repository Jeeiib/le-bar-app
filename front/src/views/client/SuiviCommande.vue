      ...
      >
        ...
        <div class="stepper">
          <div
            class="step"
            :class="{
              done: stepIndex(item.preparationStatus) > 0,
              cur: stepIndex(item.preparationStatus) === 0,
            }"
          >
          ...
          <div
            class="step"
            :class="{
              done: stepIndex(item.preparationStatus) > 1,
              cur: stepIndex(item.preparationStatus) === 1,
            }"
          >
          ...
          <div
            class="step"
            :class="{
              done: stepIndex(item.preparationStatus) > 2,
              cur: stepIndex(item.preparationStatus) === 2,
            }"
          >
          ...
          <div
            class="step"
            :class="{
              done: stepIndex(item.preparationStatus) === 3,
              cur: stepIndex(item.preparationStatus) === 3,
            }"
          >
...
const stepIndex = (prepStatus: PrepStatus): number => {
  const steps: Record<PrepStatus, number> = {
    PREPARATION_INGREDIENTS: 0,
    ASSEMBLAGE: 1,
    DRESSAGE: 2,
    TERMINEE: 3,
  }
  return steps[prepStatus] ?? 0
}
